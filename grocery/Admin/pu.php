...
$eee=$obj->query("update product set pname='$pname',description='$description',price='$price',company='$company',cat='$cat',subcat='$subcat',img='$filename' where id='$id' ");
												...
												<div class="row">
													<div class="col-md-8">
														...
														<div class="mb-3">
	    													...
	    													<textarea rows="2" class="form-control" id="description" name="description" placeholder="Tell something about Product">
	                                              ...
	                                              <?php
													...
													<br><img src="img/Product/<?php echo "$product->img" ?>"  height="120" width="150"><input type="file" name="f" id="f">
														</div>
													</div>
													<div class="col-md-4">

                                                    ...
                                                    <div id="account-info">
                                                        ...
                                                        <div class="row form-group required">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="password" class="form-control" name="opsd" id="opsd" placeholder="Old Password" value="">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
                                                            <label class="col-md-12 col-sm-12 control-label">New Password</label>
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="password" class="form-control" id="npsd" name="npsd" placeholder="New Password" value="">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
                                                            <label class="col-md-12 col-sm-12 control-label">ReEnter Password</label>
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="password" class="form-control" id="cpsd" placeholder="Confirm Password" value="" name="cpsd">
                                                            </div>
                                                        </div>

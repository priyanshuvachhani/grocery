                                                    ...
                                                    <div id="account-info">
                                                        ...
                                                        <div class="row form-group required">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="text" class="form-control" name="fname" id="fname" placeholder="First Name" value="<?php echo $result->fname; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
                                                            <label class="col-md-12 col-sm-12 control-label">Last Name</label>
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="text" class="form-control" id="lname" name="lname" placeholder="Last Name" value="<?php echo $result->lname; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
                                                            <label class="col-md-12 col-sm-12 control-label">Email</label>
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="text" class="form-control" id="email" placeholder="Email" value="<?php echo $result->email; ?>" name="email">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
                                                            <label class="col-md-12 col-sm-12 control-label">Contact</label>
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="text" class="form-control" id="contact" placeholder="Contact" value="<?php echo $result->contact; ?>" name="contact">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
                                                            <label class="col-md-12 col-sm-12 control-label">Address</label>
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="text" class="form-control" id="address" placeholder="Address" value="<?php echo $result->address; ?>" name="address">
                                                            </div>
                                                        </div>

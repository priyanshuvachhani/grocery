...
if (isset($_POST['submit'])) 
{
   ...
   $e =$obj->query("insert into feedback(customerid,message,date) values ('$name','$message','$date')");
    if ($e) 
    {
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3">
                        <div class="sidebar-content">
                            <div class="section-title no-margin"><h2>Inquries</h2></div>
						...
						<div class="contact-us-area">
							...
							<div class="contact-us-form">
								...
								<div class="contact-form">
									<span class="legend">Inquries Information</span>
									<form  method="post">
										<div class="form-top">
                                            ...
                                            <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                                <label>Date<span class="required" title="required">*</span></label>
